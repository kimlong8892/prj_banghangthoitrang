    ...
    <div class="row justify-content-center">
        <div class="col-md-7 col-lg-5">
            <div class="login-wrap p-4 p-md-5">
                ...
                <form action="{{ route('admin.password.update') }}" class="login-form" method="POST">
                    @csrf
                    <input type="hidden" name="token" value="{{ $token ?? '' }}">
                    <div class="form-group">
                        <input type="text" name="email"
                               class="form-control rounded-left @error('email') is-invalid @enderror"
                               placeholder="{{ __('email') }}" value="{{ request()->get('email') }}">
                        @error('email')
                    ...
                    <div class="form-group">
                        <input type="password" name="confirm_password"
                               ...
                               class="form-control rounded-left @error('confirm_password') is-invalid @enderror"
